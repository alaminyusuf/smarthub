									...
									<ul>
										<li>
											<Link href='javascript:void(0)'>
												<a className='text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 capitalize'>
													for companies
												</a>
											</Link>
										</li>
										...
										<li className='mt-6'>
											<a
												...
												className='text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 capitalize'
											>
												Learning
											</a>
										</li>
